...
import com.rustbuilder.ai.rl.domain.StepRewardFunction;
...
import com.rustbuilder.ai.rl.policy.multidiscrete.MultiDiscreteCreditAssignment;
        ...
        try {
            ...
            if (multiAction == null || multiAction.getTypeIndex() == MultiDiscreteActionSpace.STOP_TYPE_INDEX) {
                ...
                if (multiDiscreteMemory != null && stateEncoded != null) {
                    ...
                    com.rustbuilder.ai.rl.policy.multidiscrete.MultiDiscreteExperienceReplay.Transition trans = new com.rustbuilder.ai.rl.policy.multidiscrete.MultiDiscreteExperienceReplay.Transition(
                    ...
                    if (shouldTrainAtStep(step)) {
                        ...
                        List<com.rustbuilder.ai.rl.policy.multidiscrete.MultiDiscreteExperienceReplay.Transition> batch = multiDiscreteMemory.sample(TRAIN_BATCH_SIZE);
