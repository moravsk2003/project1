...
public class EpisodeResult {
    ...
    public com.rustbuilder.ai.rl.domain.log.StopReason stopReason = com.rustbuilder.ai.rl.domain.log.StopReason.UNKNOWN;
    ...
    public com.rustbuilder.ai.rl.environment.state.GlobalFeatureDiagnostics globalDiag = null;
