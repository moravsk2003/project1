...
public class EpisodeEvaluator {
    ...
    public void evaluate(EpisodeResult result, int maxStepsPerEpisode, int epoch, int ep, int totalEpisodes, com.rustbuilder.ai.rl.policy.multidiscrete.MultiDiscreteExperienceReplay multiDiscreteMemory) {
