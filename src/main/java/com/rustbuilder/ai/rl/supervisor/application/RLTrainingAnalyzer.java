...
public class RLTrainingAnalyzer {
    public SupervisorObservation summarize(String branchId, TrainingMetrics metrics, EpisodeResult result, com.rustbuilder.ai.rl.domain.RLRewardConfig currentConfig) {
    ...
    public SupervisorObservation summarize(String branchId,
                                           ...
                                           com.rustbuilder.ai.rl.domain.RLRewardConfig currentConfig,
