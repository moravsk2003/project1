...
public class RLRewardConfig implements Serializable, Cloneable {
    ...
    public double disconnectedSegmentPenalty = -0.1;
    
    public double stabilityRewardMult = 0.04;
    public double floatingBlockPenalty = -0.1;
    ...
    public double spatialScatteredPenalty = -0.1;
    
    // --- Step Penalties (Invalid Actions) ---
    public double penaltyNoSupport = -0.07;
    public double penaltyBadSocket = -0.5;
    public double penaltyCollision = -0.02;
    public double penaltyFloorConstraint = -0.04;
    public double penaltyGenericInvalid = -0.02;

    // --- Growth Bonuses (Multi-Discrete Flow) ---
    public double blockGrowthReward = 0.15;
    public double growthStreakBonus = 0.03;
    public double noGrowthPenalty = -0.02;
